...
public class BillingPanel extends JPanel {
    ...
    private JComponent buildCenter() {
        ...
        txtSearch.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            ...
            @Override public void insertUpdate(javax.swing.event.DocumentEvent e) { ref(); }
            @Override public void removeUpdate(javax.swing.event.DocumentEvent e) { ref(); }
            @Override public void changedUpdate(javax.swing.event.DocumentEvent e) { ref(); }
        });
    ...
    // Minimal placeholder models to allow the frontend to compile if the backend.model package is not available.
    // These are lightweight placeholders; replace/remove them when the real backend model classes are present.
    class Bill {
        public java.util.UUID id;
        public java.time.YearMonth month;
        ...
        public java.time.LocalDate paidDate;
    
        enum Status { PENDING, PAID }
    }
    
    class Settings {
        // Placeholder for settings returned by the service.
    }
    ...
    class Customer {
        ...
        @Override public String toString() {
            ...
            return id == null ? "Customer" : id.toString();
        }
    }
        if (c == null) {
